...
export const partners: Partner[] = [
  {
    ...
    description:
      'Kitchen Table Cabinetry is a licensed distributor of Kitchen Craft cabinetry and cabinet parts. Kitchen Craft has been manufacturing fine quality cabinetry in Winnipeg, Manitoba since 1971. As part of the MasterBrand Cabinets family, Kitchen Craft is known for their European-style full-access (frameless) cabinet system that prioritizes usable interior space and clean architectural lines. Every cabinet is crafted with precision and backed by a Lifetime Warranty — your investment is protected for as long as you own your home. Their products meet or exceed ANSI A161.1 performance and construction standards as certified by ICC-ES.',
    ...
    features: [
      ...
      'Licensed distributor — buy cabinets & parts through Kitchen Table Cabinetry',
    ],
  },
  {
